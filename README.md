...
Не приветствуется конкуренция с решениями [Infostart Toolkit](https://infostart.ru/marketplace/toolkit/) и Infostart DataFormWizard (УДиФ), а также решения перепродающие библиотеку.
